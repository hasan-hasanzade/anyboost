        ...
        <div className={styles.item}>
          ...
          <div className={styles.currentRating}>
            <div className={styles.currentCalc}>
              <button className={styles.subtract} onClick={decrementRating}>-</button>
              ...
              <button className={styles.add} onClick={incrementRating}>+</button>
            </div>
          </div>
        </div>
        ...
        <div className={styles.item}>
          <div className={styles.desiredRating}>
            <div className={styles.desiredCalc}>
              <button className={styles.subtract} onClick={decrementWins}>-</button>
              <div className={styles.center}>
              ...
              <button className={styles.add} onClick={incrementWins}>+</button>
            </div>
          </div>
        </div>
      </div>
