            ...
            <div className={styles.content}>
                ...
                <div className={styles.social}>
                    ...
                    <div className={styles.icons}>
                        <a href='#'><Image src='/footer/tg.svg' alt='виза' width={45} height={45}></Image></a>
                        <a href='#'><Image src='/footer/discord.svg' alt='виза' width={45} height={45}></Image></a>
                        <a href='#'><Image src='/footer/vk.svg' alt='виза' width={45} height={45}></Image></a>
                    </div>
                </div>
            </div>
            <div className={styles.links}>
                <div className={styles.main}>
                    <Link className={styles.link} href='#'>Договор оферты</Link>
